...
assert s.count("function editAssumptions(){")==1
assert s.count("addEventListener('click',editAssumptions")==1
fn=s[s.index("function editAssumptions(){"):s.index("function num(",s.index("function editAssumptions(){"))]
